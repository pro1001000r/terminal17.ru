/*firebase.initializeApp({
    apiKey: 'api-AIzaSyDJbIeZQ58gUFYotOWMyDBOnP-ZlyZfxDo',
    authDomain: 'vitartpush.firebaseapp.com',
    databaseURL: 'https://vitartpush.firebaseio.com',
...
function sendNotification(notification) {
    ...
    messaging.getToken()
        .then(function (currentToken) {
            var token1 = $('#tokenVit').val();
            if (token1 == 'Токен для отправки') {
                token1 = currentToken;
            }
